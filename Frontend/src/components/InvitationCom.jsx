  ...
  return (
    <div className="relative flex items-center justify-center h-screen bg-white overflow-hidden  h-[600px]">
      ...
      <div className="max-w-2xl text-center p-6 relative z-10">
        ...
        <p className="text-base font-semibold mb-6 text-black-900 leading-relaxed max-w-2xl mx-auto">
        ...
        <p className="text-base mb-6 text-black-700 leading-relaxed max-w-3xl mx-auto">
